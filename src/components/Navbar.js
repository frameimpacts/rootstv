...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-black/95 to-gray-900/95 sticky top-0 z-40 backdrop-blur-sm border-b border-gray-800">
      ...
      <>
        ...
        <div 
          className={`fixed inset-y-0 right-0 w-[280px] bg-gray-900 z-50 md:hidden transform transition-transform duration-300 ease-out ${
