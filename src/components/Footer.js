...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-black/95 to-gray-900/95 border-t border-gray-800">
            ...
            <form className="mt-4" onSubmit={handleSubscribe}>
              <div className="flex max-w-md">
                <input
                  ...
                  className="bg-gray-800/50 text-white px-4 py-2 rounded-l-md w-full focus:outline-none focus:ring-1 focus:ring-red-500 border border-gray-700 hover:border-gray-600 transition-colors"
                />
                <button
                  type="submit"
                  className="bg-red-600 text-white px-4 py-2 rounded-r-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors"
                >
                  Subscribe
                </button>
              </div>
